...
\subsubsection*{C.1 Synthetic orbit construction}
...
\subsubsection*{C.2 Sites and backbones}
...
\subsubsection*{C.3 Depth-grid protocol}
...
\subsubsection*{C.4 The three tasks and their holdouts}
...
\subsubsection*{C.5 Fitting protocol}
...
\subsubsection*{C.6 Power gate and baselines}
...
\midrule
random orthogonal & ResNet-50 hue \texttt{layer1} & $T_F=-0.912$, win rate $0.003$, projection $0.530$ \\
shuffled pair, conv-res & seeds 0/1/2 & win rate $0.110$/$0.105$/$0.085$; projection $1.267$/$1.506$/$1.383$ \\
\bottomrule
\end{tabularx}
\end{table*}

\subsubsection*{C.7 Real-region protocol}
